          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg md:text-xl text-slate-600 max-w-md leading-relaxed">
                Wir sind Webora — Ihr Partner für professionelles Application Testing. 
      ...
      <section className="py-24 md:py-32 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Content Side */}
            <div className="space-y-8">
              <span className="text-[#0EA5E9] font-mono text-sm uppercase tracking-widest">Warum Webora</span>
