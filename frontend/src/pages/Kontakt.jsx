          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="lg:pl-12">
              ...
              <div className="space-y-8 mb-12">
                <a href="mailto:info@webora.de" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <div className="text-[#4A4A4A] group-hover:text-[#0EA5E9] transition-colors">info@webora.de</div>
                  </div>
                </a>
      ...
      <section className="h-96 bg-[#F4F7F5] relative">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-[#4A4A4A] font-medium">Darmstädter Landstraße 60, 65462 Ginsheim-Gustavsburg</p>
          </div>
        </div>
      </section>
    </div>
