        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12 mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl space-y-2 text-gray-700">
              <p className="font-semibold text-lg">MO Handel & Service, Inh. Mariusz Otok</p>
              <p>Darmstädter Landstraße 60</p>
              <p>65462 Ginsheim-Gustavsburg</p>
              <p>Deutschland</p>
              <p className="pt-3">E-Mail: datenschutz@webora.de</p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
            ...
            <div className="bg-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">MO Handel & Service, Inh. Mariusz Otok</p>
              <p className="text-gray-700">E-Mail: datenschutz@webora.de</p>
            </div>
          </div>
