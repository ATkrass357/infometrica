          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="lg:pl-12">
              ...
              <div className="space-y-8 mb-12">
                <a href="mailto:info@keyperion-technologies.de" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <div className="text-[#4A4A4A] group-hover:text-[#00C853] transition-colors">info@keyperion-technologies.de</div>
                  </div>
                </a>
