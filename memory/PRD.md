...
## Last Updated
2026-06-30 (4): Bewerber-Anliegen in DE- & AT-Arbeitsverträge eingearbeitet (Frontend ContractTemplates.jsx + Backend applications.py, jeweils parallel). Neue §§ vor der Datenschutz-Testzwecke-Klausel: (1) Sozialversicherung/Anmeldung & Versicherungsschutz – DE: gesetzl. Krankenkasse; Minijob: Minijob-Zentrale + Hinweis kein eigener KV-Schutz; AT: ÖGK/ASVG. (2) Sonderzahlungen 13./14. Gehalt – AT: Urlaubszuschuss + Weihnachtsremuneration (aliquot); DE: transparent kein gesetzl. Anspruch. (3) AT: Kollektivvertrag (im Zweifel Handel); DE: Tarifbindung + Mindestlohn (MiLoG). (4) Vertraulichkeit – konkrete Verstöße (a–e) + Folgen (Haftung, außerord. Kündigung, AT: Vertragsstrafe 5.000 €). Betrifft 5 Arbeitsverträge (vollzeit, teilzeit, minijob, vollzeit_at, teilzeit_at); Werk-/Freiberufler-Verträge (minijob_at, freiberufler_at) NICHT. Nummerierung angepasst, Datenschutz-Testzwecke bleibt letzte §. Verifiziert: alle 5 Typen enthalten neue Klauseln, genau 1 Datenschutz-Sektion. HINWEIS: KV-Name „Handel" und ÖGK sind Standard-Annahmen – Nutzer sollte exakten KV bestätigen.
