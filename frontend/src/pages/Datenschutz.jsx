        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12 mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl space-y-2 text-gray-700">
              <p className="font-semibold text-lg">Prysm Technologies GmbH</p>
              <p>Große Gallusstr. 14</p>
              <p>60315 Frankfurt am Main</p>
              <p>Deutschland</p>
              <p className="pt-3">E-Mail: datenschutz@prysm-technologies.com</p>
            </div>
            ...
            return (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8 lg:p-12 mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-12 h-12 bg-#E0F2FE rounded-xl flex items-center justify-center mr-4">
          ...
          <div className="bg-orange-50 rounded-2xl shadow-lg p-8 lg:p-12 mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start">
                <div className="w-6 h-6 bg-#0EA5E9 rounded-full flex items-center justify-center mr-3 mt-1 flex-shrink-0">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
            ...
            <div className="bg-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">Prysm Technologies GmbH</p>
              <p className="text-gray-700">E-Mail: datenschutz@prysm-technologies.com</p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/"
              className="inline-flex items-center justify-center px-6 py-3 text-#0EA5E9 hover:text-orange-600 font-semibold transition-colors duration-200"
            >
