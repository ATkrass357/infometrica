    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-1/2 -right-1/4 w-[800px] h-[800px] rounded-full bg-gradient-to-br from-[#E0F2FE] to-transparent blur-3xl opacity-60" />
          <div className="absolute top-1/4 -left-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-[#F0F9FF] to-transparent blur-3xl opacity-40" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-[#0A0A0A] leading-[0.9]">
                Software
                <br />
                <span className="text-[#0EA5E9]">fehlerfrei</span>
                <br />
                machen.
              </h1>
              ...
              <p className="text-lg md:text-xl text-slate-600 max-w-md leading-relaxed">
                Wir sind Prysm Technologies — Ihr Partner für professionelles Application Testing. 
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link
                  ...
                  className="group inline-flex items-center gap-3 h-14 px-8 bg-[#0EA5E9] text-white font-semibold rounded-full hover:scale-105 active:scale-95 transition-transform duration-200 shadow-lg shadow-[#0EA5E9]/25"
                >
                  Projekt starten
                ...
                >
                  <Play size={18} className="text-[#0EA5E9]" />
                  So arbeiten wir
                </Link>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat, i) => (
                  <div
                    key={i}
                    className="group relative bg-white border border-slate-100 p-8 rounded-2xl hover:border-[#0EA5E9]/50 hover:-translate-y-1 transition-all duration-300"
                    style={{ animationDelay: stat.delay }}
                  >
                    <div className="absolute top-4 right-4 w-8 h-8 rounded-full bg-[#F0F9FF] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-[#F8F9FA] noise-overlay">
        <div className="max-w-[1400px] mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-16">
            <div>
              <span className="text-[#0EA5E9] font-mono text-sm uppercase tracking-widest mb-4 block">Services</span>
            ...
            <Link
              to="/dienstleistungen"
              className="group inline-flex items-center gap-2 text-[#0A0A0A] font-semibold hover:text-[#0EA5E9] transition-colors"
            >
              Alle Services
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-2 group relative bg-[#0A0A0A] p-10 rounded-2xl overflow-hidden hover-lift">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#0EA5E9]/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2" />
              <div className="relative z-10">
                <Shield className="text-[#0EA5E9] mb-6" size={48} strokeWidth={1.5} />
            ...
            {/* Small Card - Accent */}
            <div className="group relative bg-[#0EA5E9] p-8 rounded-2xl overflow-hidden hover-lift">
            ...
            {/* Small Card */}
            <div className="group relative bg-white border border-slate-100 p-8 rounded-2xl hover:border-[#0EA5E9]/50 transition-colors hover-lift">
            ...
            <div className="md:col-span-2 group relative bg-gradient-to-br from-slate-50 to-white border border-slate-100 p-10 rounded-2xl overflow-hidden hover-lift">
              <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#0EA5E9]/5 rounded-full blur-2xl" />
              <div className="relative z-10">
                <Code2 className="text-[#0EA5E9] mb-6" size={48} strokeWidth={1.5} />
            ...
            <div className="md:col-span-2 group relative bg-[#0A0A0A] p-8 rounded-2xl flex items-center gap-8 hover-lift">
              <div className="flex-1">
                <span className="text-[#0EA5E9] font-mono text-xs uppercase tracking-widest mb-2 block">Neu</span>
              ...
              <Link to="/dienstleistungen" className="w-12 h-12 rounded-full bg-[#0EA5E9] flex items-center justify-center hover:scale-110 transition-transform">
      ...
      <section className="py-24 md:py-32 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Content Side */}
            <div className="space-y-8">
              <span className="text-[#0EA5E9] font-mono text-sm uppercase tracking-widest">Warum Prysm Technologies</span>
              ...
              <div className="space-y-6 pt-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 group">
                    <div className="w-12 h-12 rounded-full border-2 border-slate-200 flex items-center justify-center group-hover:border-[#0EA5E9] group-hover:bg-[#0EA5E9] transition-all duration-300">
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#0EA5E9]/10 rounded-full blur-3xl" />
        
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <span className="text-[#0EA5E9] font-mono text-sm uppercase tracking-widest mb-6 block">Loslegen</span>
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[0.95]">
            Bereit für<br />
            <span className="text-[#0EA5E9]">fehlerfreie</span> Apps?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="group inline-flex items-center justify-center gap-3 h-16 px-10 bg-[#0EA5E9] text-white font-bold text-lg rounded-full hover:scale-105 active:scale-95 transition-transform duration-200 shadow-lg shadow-[#0EA5E9]/30"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-3 h-16 px-10 border-2 border-slate-700 text-white font-bold text-lg rounded-full hover:border-[#0EA5E9] hover:text-[#0EA5E9] transition-colors duration-200"
            >
              Karriere bei uns
            </Link>
          </div>
